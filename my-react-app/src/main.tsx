...
ReactDOM.createRoot(document.getElementById('root')!).render(
  <React.StrictMode>
    <div className="absolute overflow-x-hidden top-0 z-[-2] h-full w-screen bg-color-bg1 bg-[radial-gradient(ellipse_50%_90%_at_50%_-20%,rgba(193,201,250,0.3),rgba(255,255,255,0))]'"></div>
      <App />
